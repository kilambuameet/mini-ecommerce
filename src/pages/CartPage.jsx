    ...
    <div className="max-w-5xl mx-auto mt-10 p-6 bg-white shadow-md rounded-lg">
      ...
      <div className="mt-6 flex justify-between items-center">
        ...
        <div className="flex justify-between items-center gap-4 flex-wrap">
          <Link to="/" className="bg-green-500 text-white px-6 py-2 rounded-full hover:bg-green-600 transition duration-300 cursor-pointer">
            Continue Shopping
          </Link>
          <button className="bg-transparent border border-blue-500 text-black px-6 py-2 rounded-full hover:bg-blue-600 transition duration-300 hover:text-white cursor-pointer">
            Checkout
          </button>
        </div>
      </div>
